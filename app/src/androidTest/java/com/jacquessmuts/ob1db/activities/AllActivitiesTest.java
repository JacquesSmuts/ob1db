...
public class AllActivitiesTest {
    ...
    public void clickthroughTest() {
        //TODO: The IdlingResource is supposed to stop the test until all API calls have finished
        //TODO: but it doesn't work and I don't know why. So, sleep it is for now :(
        try {
            Thread.sleep(12000);
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.recycler_film_list),
                        childAtPosition(
